...
<head>
  ...
  <title>Garbage Collectors, Rooftop, Laundry, Fire Exit Tasking Form</title>
...
<body>
  ...
  <div class="form-container">
    <div class="form-header">
      <div class="form-title">
        TASKING: <span class="team-name">GARBAGE COLLECTORS, ROOFTOP, LAUNDRY, FIRE EXIT</span>
      </div>
      <div class="form-info">
    ...
    <table class="tasking-table">
      <thead>
        <tr>
          <th style="width: 120px;">AREA/DAY</th>
      ...
      <tbody>
        <!-- Garbage Row 1 -->
        <tr>
          <td rowspan="3" class="area-header">GARBAGE</td>
          <td class="task-cell"><textarea class="task-input" placeholder="Assign student"></textarea></td>
          <td class="task-cell"><textarea class="task-input" placeholder="Assign student"></textarea></td>
          <td class="task-cell"><textarea class="task-input" placeholder="Assign student"></textarea></td>
          <td class="task-cell"><textarea class="task-input" placeholder="Assign student"></textarea></td>
          <td class="task-cell"><textarea class="task-input" placeholder="Assign student"></textarea></td>
        ...
        <!-- Laundry Row 1 -->
        <tr>
          <td rowspan="3" class="area-header">LAUNDRY</td>
          <td class="task-cell"><textarea class="task-input" placeholder="Assign student"></textarea></td>
          <td class="task-cell"><textarea class="task-input" placeholder="Assign student"></textarea></td>
          <td class="task-cell"><textarea class="task-input" placeholder="Assign student"></textarea></td>
          <td class="task-cell"><textarea class="task-input" placeholder="Assign student"></textarea></td>
        ...
        <!-- Rooftop Row 1 -->
        <tr>
          <td rowspan="3" class="area-header">ROOFTOP</td>
          <td class="task-cell"><textarea class="task-input" placeholder="Assign student"></textarea></td>
          <td class="task-cell"><textarea class="task-input" placeholder="Assign student"></textarea></td>
          <td class="task-cell"><textarea class="task-input" placeholder="Assign student"></textarea></td>
          <td class="task-cell"><textarea class="task-input" placeholder="Assign student"></textarea></td>
        ...
        <!-- Fire Exit Row 1 -->
        <tr>
          <td rowspan="3" class="area-header">FIRE EXIT</td>
          <td class="task-cell"><textarea class="task-input" placeholder="Assign student"></textarea></td>
          <td class="task-cell"><textarea class="task-input" placeholder="Assign student"></textarea></td>
          <td class="task-cell"><textarea class="task-input" placeholder="Assign student"></textarea></td>
          <td class="task-cell"><textarea class="task-input" placeholder="Assign student"></textarea></td>
  ...
  <script>
    function saveForm() {
      alert('Garbage Collectors, Rooftop, Laundry, Fire Exit tasking form saved successfully!');
