...
use App\Models\User;
use App\Models\PNUser; // Import the PNUser model
...
class DatabaseSeeder extends Seeder
{
    ...
    private function createPNUsers(): void
    {
        ...
        PNUser::create([
            'user_id' => 4,
            'user_fname' => 'Mark Kevin',
            'user_lname' => 'Chavez',
            'user_mInitial' => 'D',
            'user_suffix' => '',
            'gender' => 'M',
            'user_email' => 'markkevin@example.com',
            'user_password' => Hash::make('password'),
            'status' => 'active',
            'user_role' => 'student',
            'is_temp_password' => false,
        ...
        PNUser::create([
            'user_id' => 7,
            'user_fname' => 'Eupe',
            'user_lname' => 'Estelloro',
            'user_mInitial' => 'H',
            'user_suffix' => '',
            'gender' => 'F',
            'user_email' => 'eupe@example.com',
            'user_password' => Hash::make('password'),
            'status' => 'active',
            'user_role' => 'student',
            'is_temp_password' => false,
