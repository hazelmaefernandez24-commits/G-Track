...
{
    /**
     * Display weekly menu dishes (View Only for Kitchen Team)
     */
    public function index()
    {
        ...
        return view('kitchen.weekly-menu-dishes.index', compact(
            'inventoryItems', 
            'week1Dishes', 
            'week2Dishes',
            'today',
    ...
    public function show($id)
    {
        ...
        return view('kitchen.weekly-menu-dishes.show', compact('dish'));
    }
