...
<div class="container-fluid p-4">
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-header text-white d-flex justify-content-between align-items-center" 
                    ...
                    <div>
                        <h4 class="mb-0"><i class="bi bi-calendar-week"></i> Weekly Menu Dishes</h4>
                        <small>View planned meals for the week</small>
                    </div>
                    <div class="text-end">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="card border-0 shadow-sm" style="border-left: 4px solid #22bbea !important;">
            ...
            <div class="card main-card">
                ...
                <div class="card-body p-0" id="weeklyMenuContainer">
                    ...
                    <div id="week1Content" style="display: {{ $currentWeek == 1 ? 'block' : 'none' }};">
                        @include('kitchen.weekly-menu-dishes.week-table', ['weekCycle' => 1, 'dishes' => $week1Dishes])
                    </div>
                    
                    <!-- Week 2 Content -->
                    <div id="week2Content" style="display: {{ $currentWeek == 2 ? 'block' : 'none' }};">
                        @include('kitchen.weekly-menu-dishes.week-table', ['weekCycle' => 2, 'dishes' => $week2Dishes])
                    </div>
                </div>
            </div>
        </div>
