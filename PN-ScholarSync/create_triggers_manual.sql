-- Manual trigger creation script
-- Run this if you prefer to create triggers directly via SQL

-- Drop existing triggers if they exist
DROP TRIGGER IF EXISTS tr_after_academic_validation;
DROP TRIGGER IF EXISTS tr_after_going_out_validation;

-- Create trigger for academics table
DELIMITER $$
...
-- Create trigger for going_outs table
