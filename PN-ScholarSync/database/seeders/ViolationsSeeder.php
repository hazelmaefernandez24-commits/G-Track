...
class ViolationsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $violationTypes = [
            ...
            ['violation_name' => 'Being pregnant or impregnating someone.', 'offense_category_id' => $generalBehaviorCategoryId, 'default_penalty' => 'T', 'severity_id' => $veryHighId],
            ['violation_name' => 'Using illegal drugs and engaging in substance abuse.', 'offense_category_id' => $generalBehaviorCategoryId, 'default_penalty' => 'T', 'severity_id' => $veryHighId],
            ['violation_name' => 'Having intimate/sexual relationships between staff/teachers and students.', 'offense_category_id' => $generalBehaviorCategoryId, 'default_penalty' => 'T', 'severity_id' => $veryHighId],
            ['violation_name' => 'Having sexual relationship between fellow PN students.', 'offense_category_id' => $generalBehaviorCategoryId, 'default_penalty' => 'T', 'severity_id' => $veryHighId],
            ...
            // Logify Integration - Schedule violations for late/absent records
            ['violation_name' => 'Late academic login/logout.', 'offense_category_id' => $scheduleCategoryId, 'default_penalty' => 'VW', 'severity_id' => $lowId],
            ['violation_name' => 'Late going out login/logout.', 'offense_category_id' => $scheduleCategoryId, 'default_penalty' => 'VW', 'severity_id' => $lowId],
            ['violation_name' => 'Academic absence without valid excuse.', 'offense_category_id' => $scheduleCategoryId, 'default_penalty' => 'VW', 'severity_id' => $lowId],
