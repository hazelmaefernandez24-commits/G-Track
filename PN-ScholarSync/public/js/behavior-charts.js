...
function updateBehaviorChart(data, title) {
    if (window.behaviorChart) {
        ...
        // Update chart title
        window.behaviorChart.options.plugins.title.text = title;
...
window.filterDataByBatchRange = function(startYear, endYear) {
    ...
    .then(data => {
        ...
        // Use helper function to update chart
        updateBehaviorChart(data, `Student Violations by Month (Batches ${startYear}-${endYear})`);
...
window.filterDataByBatch = function(batch) {
    ...
    .then(data => {
        ...
        // Use helper function to update chart
        const title = `Student Violations by Month ${batch === 'all' ? '' : '(' + batch + ')'}`;
        updateBehaviorChart(data, title);
