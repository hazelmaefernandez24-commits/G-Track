...
@section('title', 'Resolved Violation Cases')
...
<div class="container-fluid px-1">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="mb-0"><i class="fas fa-check-circle text-success me-2"></i>Resolved Violation Cases</h2>
        <a href="{{ route('educator.dashboard') }}" class="btn btn-secondary">Back</a>
    </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        @empty
                        <tr>
                            <td colspan="4" class="text-center">No resolved violation cases found.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
