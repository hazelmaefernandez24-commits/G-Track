                                ...
                                <div class='message-item'
                                    ...
                                    <div class='message-meta'
                                        ...
                                        <div
                                            ...
                                            <div
                                                style="background: #0f172a; border-radius: 8px; padding: 10px; min-height: 120px; display: flex; flex-direction: column; justify-content: center; position: relative; overflow: hidden;">
                                                <div
                                                    style="position: absolute; top: 8px; left: 8px; background: rgba(220, 38, 38, 0.9); color: #fff; font-size: 8px; font-weight: 900; padding: 2px 6px; border-radius: 4px; text-transform: uppercase; z-index: 10; display: flex; align-items: center; gap: 4px;">
                                                    <span
                                                        style="width: 6px; height: 6px; background: #fff; border-radius: 50%; animate: pulse 1s infinite;"></span>
                                                    Live Video Feed
                                                </div>
                                            ...
                                            <div
                                                style="background: #1e293b; border-radius: 8px; padding: 10px; min-height: 120px; display: flex; flex-direction: column; justify-content: center; position: relative;">
                                                <div
                                                    style="position: absolute; top: 8px; left: 8px; background: rgba(37, 99, 235, 0.9); color: #fff; font-size: 8px; font-weight: 900; padding: 2px 6px; border-radius: 4px; text-transform: uppercase; z-index: 10;">
                                                    Live Audio
                                                </div>
                                                ...
                                                @if($notification->audio_url || (isset($notification->media_url) && Str::endsWith($notification->media_url, ['.mp3', '.wav'])))
                                                    <div style="padding-top: 10px;">
                                                        <audio controls style="width: 100%;">
                                                            <source src="{{ $notification->audio_url ?? $notification->media_url }}"
                                                                type="audio/mpeg">
                                                        </audio>
                                                    </div>
                                                @else
                                            ...
                                            <div class='message-meta'
                                                ...
                                                <div>
                                                    <div
                                                        ...
                                                        Live Battery</div>
                                                    <div
                                                        style="font-weight: 700; color: {{ $currentBattery < 20 ? 'var(--red)' : '#0f172a' }}; font-size: 14px; margin-top: 2px;">
                                                        🔋 {{ $currentBattery ?? 'N/A' }}{{ $currentBattery ? '%' : '' }}
                                                    </div>
                                                </div>
                                                <div>
