...
<body>
                ...
                <li class="dropdown {{ request()->routeIs('training.grade-submissions.*') ? 'active' : '' }}" id="gradeSubmissionDropdown">
                    ...
                    <div class="dropdown-content">
                        ...
                        <a href="{{ route('training.intern-grades.index') }}" class="{{ request()->routeIs('training.intern-grades.*') ? 'active' : '' }}">
                            <img src="{{ asset('images/intern.png') }}" alt="Intern"> Intern Grades
                        </a>
    ...
    <img src="{{ asset('images/analytics.png') }}" alt="Class Progress"> Class Progress
                ...
                <li class="{{ request()->routeIs('training.internship.*') ? 'active' : '' }}">
                    <a href="{{ route('training.internship.index') }}">
                        <img src="{{ asset('images/intern.png') }}" alt="Intervention Status"> Internship
                    </a>
                </li>
                ...
                <li class="{{ request()->routeIs('training.calendar.*') ? 'active' : '' }}">
