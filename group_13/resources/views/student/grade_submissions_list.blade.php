...
<div class="submissions-main-container">
    ...
    <!-- Submissions Section -->
    @if(isset($gradeSubmissions) && $gradeSubmissions->count())
        <div class="card-slim">
                    ...
                    <table>
                        ...
                        <tbody>
                            @foreach($gradeSubmissions as $submission)
                                <tr>
                                    <td>
                                        <strong>{{ $submission->semester }} {{ ucfirst($submission->term) }}</strong>
                                    </td>
                                    <td>AY {{ $submission->academic_year }}</td>
                                    <td>
                                        <span class="pill {{ strtolower($submission->status) }}">{{ ucfirst($submission->status) }}</span>
                                    </td>
                                    <td>{{ optional($submission->updated_at)->format('M d, Y') }}</td>
                                    <td>
                                        <a href="{{ route('student.view-submission', $submission->id) }}" class="btn-primary">View</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
