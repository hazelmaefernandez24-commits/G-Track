...
<div class="container-fluid" style="padding: 20px;">
    <div class="calendar-container">
        <div class="calendar-header">
            ...
            <p class="calendar-subtitle"><?php echo e(now()->format('Y')); ?> Calendar</p>
        </div>

        <div class="calendar-content">
            <!-- Action Buttons -->
            <div class="action-buttons">
                <a href="<?php echo e(route('training.calendar.manage')); ?>" class="btn btn-secondary">
                    <i class="fas fa-list"></i> Manage Events
                </a>
                <a href="<?php echo e(route('training.calendar.create')); ?>" class="btn btn-primary">
...
<?php echo $__env->make('layouts.nav', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\CAPSTONE\PN_Systems\group_13\resources\views/training/calendar/index.blade.php ENDPATH**/ ?>