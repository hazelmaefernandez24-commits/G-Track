    ...
    <div class="layout-container">
        <aside class="sidebar">
            <ul class="menu">
                ...
                <li class="<?php echo e(request()->routeIs('educator.calendar.*') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('educator.calendar.index')); ?>">
...
<?php /**PATH C:\CAPSTONE\PN_Systems\group_13\resources\views/layouts/educator_layout.blade.php ENDPATH**/ ?>