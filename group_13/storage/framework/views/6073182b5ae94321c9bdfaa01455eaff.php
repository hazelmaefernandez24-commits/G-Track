            ...
            <?php if(auth()->guard()->check()): ?>
                ...
                <?php if($role === 'student'): ?>
                    ...
                    <ul class="menu">
                        ...
                        <li class="<?php echo e(request()->routeIs('student.calendar.*') ? 'active' : ''); ?>">
                            <a href="<?php echo e(route('student.calendar.index')); ?>">
                                <img src="<?php echo e(asset('images/calendar.png')); ?>" alt="Calendar" class="menu-icon"> Calendar
                            </a>
                        </li>
                    </ul>
                    ...
                    <div class="mobile-nav-menu" style="background: white; padding: 0; margin: 0;">
                        ...
                        <!-- Calendar -->
                        <div style="border-bottom: 1px solid #eee; margin: 0; padding: 0;" class="<?php echo e(request()->routeIs('student.calendar.*') ? 'mobile-nav-active' : ''); ?>">
                            <button onclick="closeMobileMenuAndNavigate('<?php echo e(route('student.calendar.index')); ?>')"
                                    style="width: 100%; background: <?php echo e(request()->routeIs('student.calendar.*') ? '#e3f2fd' : 'white'); ?>; color: <?php echo e(request()->routeIs('student.calendar.*') ? '#22bbea' : '#333'); ?>; padding: 18px 20px; border: none;
                                           text-align: left; cursor: pointer; display: flex; align-items: center;
                                           min-height: 56px; touch-action: manipulation; font-size: 16px; font-weight: <?php echo e(request()->routeIs('student.calendar.*') ? '500' : 'normal'); ?>;">
                                <img src="<?php echo e(asset('images/calendar.png')); ?>" alt="Calendar" style="width: 24px; height: 24px; margin-right: 12px;">
                                <span>Calendar</span>
                            </button>
                        </div>
...
</html> <?php /**PATH C:\CAPSTONE\PN_Systems\group_13\resources\views/layouts/student_layout.blade.php ENDPATH**/ ?>