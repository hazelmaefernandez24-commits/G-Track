...
<style>
    ...
    /* Mobile enhancements - layout-only, no markup changes */
    @media (max-width: 576px) {
        .calendar-container { margin: 10px; border-radius: 12px; }
        .calendar-header { padding: 14px; }
        .calendar-title { font-size: 1.3rem; }
        .calendar-subtitle { font-size: .85rem; }
        .calendar-content { padding: 14px; }

        .semester-buttons { gap: 6px; }
        .semester-btn { padding: 6px 10px; font-size: .8rem; }

        .calendar-legend { padding: 10px; gap: 8px; }
        .legend-item { font-size: .8rem; }

        .table-responsive { overflow-x: auto; -webkit-overflow-scrolling: touch; }
        table { min-width: 600px; }

        /* Sticky header for better context on small screens */
...
<div class="container-fluid" style="padding: 20px;">
    <div class="calendar-container">
        <div class="calendar-header">
            ...
            <p class="calendar-subtitle"><?php echo e(now()->format('Y')); ?> Calendar - View Only</p>
        </div>
        ...
        <div class="calendar-content">
            ...
            <div class="view-only-notice">
                ...
                <span>This calendar displays all academic events and activities. You can view but cannot modify events.</span>
            </div>
                ...
                <table>
                    ...
                    <tbody id="events-tbody">
                        <?php $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr data-category="<?php echo e($event['category']); ?>">
                                <td><?php echo e($event['title']); ?></td>
                                <td><?php echo e(\Carbon\Carbon::parse($event['start'])->format('M d, Y')); ?></td>
                                <td><?php echo e($event['end'] ? \Carbon\Carbon::parse($event['end'])->format('M d, Y') : \Carbon\Carbon::parse($event['start'])->format('M d, Y')); ?></td>
                                <td>
                                    <?php if($event['category'] === 'school_activity'): ?>
                                        <span class="badge badge-activity">Activity</span>
                                    <?php elseif($event['category'] === 'holiday'): ?>
                                        <span class="badge badge-holiday">Holiday</span>
                                    <?php elseif($event['category'] === 'examination'): ?>
                                        <span class="badge badge-examination">Examination</span>
                                    <?php elseif($event['category'] === 'deadline'): ?>
                                        <span class="badge badge-deadline">Deadline</span>
                                    <?php elseif($event['category'] === 'vacation'): ?>
                                        <span class="badge badge-vacation">Vacation</span>
                                    <?php elseif($event['category'] === 'special'): ?>
                                        <span class="badge badge-special">Special Event</span>
                                    <?php else: ?>
                                        <span class="badge"><?php echo e(ucfirst(str_replace('_',' ',$event['category']))); ?></span>
                                    <?php endif; ?>
                                </td>
                        ...
                        <?php $__currentLoopData = $fixedHolidays; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Normalize all row data-category attributes
    rows.forEach(row => {
...
<?php echo $__env->make('layouts.student_layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\CAPSTONE\PN_Systems\group_13\resources\views/student/calendar/index.blade.php ENDPATH**/ ?>